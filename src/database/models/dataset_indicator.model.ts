...
@Table({ tableName: 'dataset_indicator', schema: 'statistics', timestamps: false, underscored: true })
...
> {
  @Column({ field: 'dataset_indicator_id', type: DataType.UUID, allowNull: false, primaryKey: true, defaultValue: DataType.UUIDV4 })

...
@Table({ tableName: 'quality_dimension', schema: 'quality_lineage', timestamps: false, underscored: true })
...
> {
  @Column({ field: 'quality_dimension_id', type: DataType.UUID, allowNull: false, primaryKey: true, defaultValue: DataType.UUIDV4 })

/**
 * The article view exactly as migration 0052 wrote it.
 *
 * It lives outside the migrations folder because everything in that folder is
 * a migration to the runner, and because the file limit is 299 lines while this
 * vocabulary is longer than that. It is a snapshot
 * and is never edited: a later change to how coverage is filed is a later
...
SELECT
  ...
  CASE
    ...
    WHEN subject ILIKE ANY (ARRAY[
      ...
      '%la firma%', '%bcp%', '%bnb%', '%bdp%', '%banco ganadero%',

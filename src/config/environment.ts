...
const environmentSchema = z
  .object({
    ...
    DATABASE_POOL_ACQUIRE_MS: z.coerce.number().int().min(1000).default(15_000),
    ...
    BACKUP_RETENTION_DAYS: z.coerce.number().int().min(1).max(3_650).default(30),
    ...
    BACKUP_MAX_DURATION_SECONDS: z.coerce.number().int().min(60).default(3_600),
  })

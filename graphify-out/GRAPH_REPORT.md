# Graph Report - EcomicDataCenter  (2026-09-03)

## Corpus Check
- 739 files · ~2,546,256 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4318 nodes · 7598 edges · 395 communities (307 shown, 88 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 53 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9ff824e6`
...
- soak-test.mjs
- database-guarantees.integration-spec.ts
...
- ConceptModel
- tracing.e2e-spec.ts
- claim-corroboration.ts
- 10. Decisión final
- QualityDimensionModel
- disclosure.policy.ts
- export-openapi.ts
- settings.json
- 0002-create-provenance-tables.ts
- 0017-create-intelligence-audit-schemas.ts
- export-openapi.ts
- 0019-create-intelligence-claim-tables.ts
- collect-bcb-quotes.ts
- 0022-add-intelligence-foreign-keys.ts
- 0023-add-intelligence-indexes.ts
- currencySeedSchema
- .importBatch
- 0027-create-intelligence-cluster-tables.ts
- 0028-grant-intelligence-cluster-tables.ts
...
- 0011-add-statistical-context-triggers.ts
- 0039-expose-filing-document-text.ts
- 0010-add-domain-integrity-constraints.ts
- 0010-add-domain-integrity-constraints.ts
- 0017-create-intelligence-audit-schemas.ts
- 0029-grant-reader-raw-observation-metrics-columns.ts
...
- evidence-content-type.ts
- 6. Diccionario de campos y validaciones exactas
- pdf-text-extractor.mjs
...
- 0033-choose-official-side-for-gap.ts
...
- verified-source-registry.ts
- name
- EntityMentionModel
- neon-cerrar.mjs
- 0045-classify-exchange-rate-indicators.ts
- neon-locks.mjs
- neon-terminar-huerfanas.mjs
- run-docker.sh
- neon-verificar.mjs
- neon-comparar.mjs
...
- .transitionIssue
- 0026-add-observation-and-retry-columns.ts
- 0032-expose-indicator-aggregation.ts
- collect-comtrade-trade.ts
- report-informal-trade.ts
- 0067-read-the-world-panel.ts
- refresh-social-snapshot.ts
- neon-comercio.mjs

## God Nodes (most connected - your core abstractions)
1. `scripts` - 82 edges
2. `MigrationContext` - 70 edges
3. `Actor` - 62 edges
4. `readSeed()` - 46 edges
5. `Prompt final especializado para backend con NestJS, TypeScript, Zod, JWT y Sequelize` - 46 edges
6. `RawObservationModel` - 45 edges
7. `MetricsService` - 44 edges
8. `SourceArtifactModel` - 43 edges
9. `FactClaimModel` - 39 edges
10. `Roles()` - 38 edges
...
- `main()` --indirect_call--> `item()`  [INFERRED]
  scripts/bbv/collect-bbv-filings.ts → src/modules/intelligence/tests/claim-corroboration.spec.ts
- `Candidate` --references--> `IndicatorMeasure`  [EXTRACTED]
  scripts/daily-economic-collector.ts → src/common/economic-indicators/indicator-codes.ts
- `readFeeds()` --indirect_call--> `item()`  [INFERRED]
  scripts/press/collect-press-coverage.ts → src/modules/intelligence/tests/claim-corroboration.spec.ts
...
## Communities (395 total, 88 thin omitted)

### Community 0 - "environment.ts"
Cohesion: 0.11
Nodes (20): reconcileWorldBankPanel(), wantedCountries(), validateSeedFiles(), agentBootstrapSeedSchema, agentSeedSchema, economicActivitySeedSchema, frequencySeedSchema, geographicUnitSeedSchema (+12 more)

### Community 1 - "governance.controller.ts"
Cohesion: 0.10
Nodes (28): GeographicUnitModel, Column, Table, QualityDimensionModel, Column, Table, Column, Table (+20 more)

### Community 2 - "index.ts"
Cohesion: 0.07
Nodes (34): aiApiKey, AiCandidate, aiProvider, Candidate, candidateSchema, desiredDailyCategories, directCollectors, DownloadedSource (+26 more)

### Community 3 - "Roles"
Cohesion: 0.09
Nodes (24): ProvenanceController, ApiBearerAuth, ApiOperation, ApiTags, Body, Controller, Get, Param (+16 more)

### Community 4 - "scripts"
Cohesion: 0.02
Nodes (81): scripts, bbv:filings, bbv:yields, bcb:collect, bcb:ufv, build, compose:validate, daily:collect (+73 more)
...
Cohesion: 0.06
Nodes (43): IndicatorRelationModel, Column, Table, LineageRelationModel, Column, Table, SeriesBreakModel, Column (+35 more)
...
Cohesion: 0.11
Nodes (16): MethodologyModel, Column, Table, MethodologyVersionModel, Column, Table, CreateMethodologyInput, MethodologyVersionInput (+8 more)
...
Cohesion: 0.05
Nodes (41): eslint, eslint-config-prettier, @eslint/js, jest, @nestjs/cli, @nestjs/testing, @opentelemetry/instrumentation, @opentelemetry/sdk-trace-node (+33 more)

### Community 13 - "observation-input.schemas.ts"
Cohesion: 0.09
Nodes (32): researchOfficialBcb(), researchParallelVenue(), INDICATOR_CODES, INDICATOR_UNITS, IndicatorFrequency, IndicatorMeasure, MACRO_INDICATOR_CODES, PriceSide (+24 more)
...
Cohesion: 0.08
Nodes (25): environment, LoggableRequest, LoggableResponse, AuditModule, Global, Module, ObservabilityModule, Global (+17 more)

### Community 17 - "observation-registration.service.ts"
Cohesion: 0.11
Nodes (22): canonicalHash(), canonicalize(), textHash(), ClaimContent, claimContentHash(), claimSubject, evidenceHash(), isComparableSubject() (+14 more)

### Community 18 - "mock-seed.metadata.ts"
Cohesion: 0.08
Nodes (25): type, type, type, type, type, type, type, properties (+17 more)
...
Cohesion: 0.14
Nodes (12): StatisticalOperationModel, Column, Table, GovernanceModule, Module, MetadataCatalogService, Inject, Injectable (+4 more)
...
Cohesion: 0.15
Nodes (15): main(), iter_core_typescript_files(), iter_files(), iter_maintained_code_files(), Path, Yield unique files from explicit roots without traversing quarantined code., Yield TypeScript files that belong to the deployed application graph., Yield deployed TypeScript and repository-owned validation scripts. (+7 more)

### Community 23 - "observation-write.repository.ts"
Cohesion: 0.33
Nodes (8): canonicalize(), hashSnapshot(), SnapshotRow, AGENT_BOOTSTRAP_IDS, BOOT_FREQUENCY_IDS, BOOT_QUALITY_DIMENSION_IDS, BOOT_UNIT_IDS, MOCK_IDS

### Community 24 - "metadata-catalog.service.ts"
Cohesion: 0.15
Nodes (13): ObservationAttributeValueModel, Column, Table, ObservationMeasureModel, Column, Table, ObservationRevisionModel, Column (+5 more)
...
Cohesion: 0.19
Nodes (8): Inject, Environment, DatabaseConnectionFactories, DatabaseConnections, defaultFactories, initializeDatabaseConnections(), DatabaseLifecycle, Inject

### Community 28 - "batch-idempotency.ts"
Cohesion: 0.20
Nodes (16): umzug, booleanFromString, environmentSchema, getEnvironment(), resetEnvironmentForTests(), main(), main(), main() (+8 more)
...
Cohesion: 0.14
Nodes (11): ConceptModel, Column, Table, GovernanceController, ApiBearerAuth, ApiOperation, ApiTags, Body (+3 more)

### Community 32 - ".registerWithinBatch"
Cohesion: 0.08
Nodes (33): Source, SOURCES, Answer, Article, dateFor(), headlineFrom(), load(), main() (+25 more)

### Community 33 - "health.controller.ts"
Cohesion: 0.06
Nodes (23): Headers, Res, Public(), SafeErrorLog, stringProperty(), toSafeErrorLog(), PoolSnapshot, DomainCountsRow (+15 more)

### Community 34 - "DimensionDefinitionModel"
Cohesion: 0.16
Nodes (15): CodeItemModel, Column, Table, CodeListModel, Column, Table, reconcileMockProvenance(), reconcileMockSemantics() (+7 more)
...
Cohesion: 0.07
Nodes (49): Req, CurrentActor, Roles(), ClaimReviewController, ApiBearerAuth, ApiOperation, ApiTags, Body (+41 more)
...
### Community 50 - "yaml"
Cohesion: 0.19
Nodes (7): yaml, main(), make_request(), Writes UTF-8 with LF endings so generated files do not depend on the OS., schema_example(), write_utf8(), yaml
...
Cohesion: 0.12
Nodes (15): required, $schema, title, type, city, commercial_role, department, entity_family (+7 more)
...
Cohesion: 0.14
Nodes (13): description, engines, node, license, name, packageManager, private, resolutions (+5 more)

### Community 60 - "exclude"
Cohesion: 0.17
Nodes (11): scripts, **/*.spec.ts, test, ./tsconfig.json, compilerOptions, incremental, rootDir, exclude (+3 more)
...
Cohesion: 0.38
Nodes (9): checks_for(), constraint_name(), main(), parse_unique(), Writes UTF-8 with LF endings so generated files do not depend on the OS., render_foreign_keys(), render_schema_migration(), sql_type() (+1 more)
...
Cohesion: 0.29
Nodes (6): Backup lógico aislado, Criterio de aprobación, Estado de decisión, Registro de pruebas de restauración, Restore drill obligatorio, Runbook de backup y restauración
...
Cohesion: 0.46
Nodes (7): camel(), main(), pascal(), Writes UTF-8 with LF endings so generated files do not depend on the OS., render_model(), type_parts(), write_utf8()
...
Cohesion: 0.48
Nodes (6): build_schema_diagrams(), build_tex(), plantuml_entity(), Writes UTF-8 with LF endings so generated files do not depend on the OS., tex(), write_utf8()
...
Cohesion: 0.20
Nodes (14): type, type, type, type, address, basic_category, official_validation_source, operating_status (+6 more)
...
Cohesion: 0.15
Nodes (16): AttributeValueInput, attributeValueSchema, decimal, importObservationBatchSchema, isoDate, MeasureValueInput, measureValueSchema, observationRecordSchema (+8 more)
...
Cohesion: 0.16
Nodes (18): ALWAYS_REVIEWED, AUTO_PUBLISHABLE, ClaimDisposition, CRITICAL_IMPACT, IMPACT_GATE_EXEMPT, LOW_CONFIDENCE, RoutableClaim, routeClaim() (+10 more)
...
Cohesion: 0.21
Nodes (13): dailyPayload(), evidenceExcerpt(), HistorySeries, measuresFor(), reconcileExchangeRateHistory(), reconcileSeries(), SERIES, reconcileHistoryArtifact() (+5 more)

### Community 137 - "fastify"
Cohesion: 0.11
Nodes (16): DataIssueModel, Column, Table, QualityAssessmentModel, Column, Table, QualityRuleModel, Column (+8 more)

### Community 138 - "@fastify/helmet"
Cohesion: 0.07
Nodes (27): AttributeDefinitionModel, Column, Table, DataStructureModel, Column, Table, DatasetIndicatorModel, Column (+19 more)

### Community 139 - "@fastify/static"
Cohesion: 0.11
Nodes (13): ApplicationError, BusinessRuleError, ConflictError, ErrorCode, InfrastructureError, NotFoundError, RequestValidationError, schema (+5 more)
...
Cohesion: 0.09
Nodes (28): collectYear(), EndpointRecord, main(), SEED, toIsoDate(), trimmedValue(), UfvPoint, UfvYear (+20 more)

### Community 146 - "nestjs-pino"
Cohesion: 0.23
Nodes (11): claimCorroborationKey(), confidenceRank, consolidateCorroboratingClaims(), CorroboratedClaim, CorroboratedClaimItem, CorroboratingEvidence, CorroboratingSource, CorroborationSummary (+3 more)

### Community 147 - "@nestjs/swagger"
Cohesion: 0.20
Nodes (4): Catch, HttpExceptionFilter, readPluginStatus(), SentResponse
...
### Community 149 - "pino"
Cohesion: 0.20
Nodes (9): Archivos, Bolivia POI — Santa Cruz, La Paz y Cochabamba, Calidad, Incluye, Nota importante, Opción 1 — macOS / Ubuntu / Linux, Opción 2 — Docker, Opción 3 — Manual (+1 more)

### Community 150 - "reflect-metadata"
Cohesion: 0.24
Nodes (10): Candle, collect(), FROM, main(), Market, MARKETS, numeric(), SEED (+2 more)
...
Cohesion: 0.07
Nodes (22): createHost(), handleInsideSpan(), logger, RequestContextInterceptor, Injectable, CapturedHeaders, ConsumedOperation, MessagingTraceService (+14 more)

### Community 169 - "environment.ts"
Cohesion: 0.10
Nodes (29): AuditAction, AuditService, Injectable, assertActorOrganization(), APP_ATTRIBUTES, TracedOperation, TracingService, Injectable (+21 more)

### Community 170 - "OrganizationModel"
Cohesion: 0.50
Nodes (3): calibrateConfidenceForSourceMetadata(), SourceMetadataVerification, UnverifiedSourceMetadataReason

### Community 172 - ".deadLetters"
Cohesion: 0.16
Nodes (15): RawObservationModel, Column, Table, alreadyHeld(), assertionFor(), loadSeries(), payloadFor(), Point (+7 more)

### Community 173 - "export-openapi.ts"
Cohesion: 0.09
Nodes (26): researchMaterialEvents(), evidenceGrade, platform, SocialReading, SocialReadings, socialReadingsSchema, subject, ADR-0022 (+18 more)
...
Cohesion: 0.27
Nodes (11): attribute(), cells(), main(), MONTHS, operationBlock(), OPERATIONS, readBlock(), SEED (+3 more)
...
Cohesion: 0.08
Nodes (23): Alta inicial del agente (solo operador), Configuración previa obligatoria, Contrato de endpoints usado por la tarea, Programación recomendada, Prompt para la tarea programada, Tarea diaria de ChatGPT: investigación económica y entrega al Data Center, Adaptador de GitHub Pages, Almacén durable de evidencia: contrato genérico y adaptador de GitHub Pages (+15 more)

### Community 179 - "RolesGuard"
Cohesion: 0.14
Nodes (22): comparableNumber(), contextualUnits(), NumericOccurrence, numericOccurrences(), occurrencesMatch(), scaleComparableNumber(), ungroundedNumbers(), assessLexicalGrounding() (+14 more)

### Community 180 - "reapply-runtime-grants.ts"
Cohesion: 0.07
Nodes (27): decimal, dimensionValueSchema, isoDate, uuid, buildDataQueryPlan(), DataQueryPlan, dimensionPredicate(), dataQuerySchema (+19 more)

### Community 181 - "UnitMeasureModel"
Cohesion: 0.04
Nodes (55): Actor, ACTOR_ROLES, ActorRole, matchesBearerToken(), CROSS_INSTITUTION_ROLES, DisclosureScope, PUBLIC_CONFIDENTIALITY, resolveDisclosureScope() (+47 more)
...
### Community 183 - "@nestjs/common"
Cohesion: 0.16
Nodes (14): jsonSourceMetadata(), publicationDateKeys, extractPdfEvidence(), metadataKeys, parseExtractionOutput(), PdfExtractionResult, PdfMetadata, pdfMetadataPublicationDates() (+6 more)

### Community 185 - "Injectable"
Cohesion: 0.24
Nodes (12): CatalogueEntry, CataloguePayload, fetchJson(), main(), Observation, readCatalogue(), readSeries(), SEEDS (+4 more)

### Community 187 - "quality.controller.ts"
Cohesion: 0.04
Nodes (44): AiAgentModel, Column, Table, ClaimClusterMemberModel, Column, Table, ClassificationItemModel, Column (+36 more)

### Community 188 - "Skill: clean-code-review"
Cohesion: 0.11
Nodes (17): Comandos permitidos, Comandos prohibidos, Criterios, Cuándo NO usarla, Cuándo usarla, Detente si, Entradas requeridas, Entregables (+9 more)

### Community 189 - "Skill: backend-hardening"
Cohesion: 0.12
Nodes (16): Comandos permitidos, Comandos prohibidos, Cuándo NO usarla, Cuándo usarla, Detente si, Entradas requeridas, Entregables, Evidencia requerida (+8 more)

### Community 190 - "Skill: backend-production"
Cohesion: 0.12
Nodes (16): Comandos permitidos, Comandos prohibidos, Cuándo NO usarla, Cuándo usarla, Detente si, Entradas requeridas, Entregables, Evidencia requerida (+8 more)

### Community 191 - "Skill: library-selection"
Cohesion: 0.12
Nodes (16): Comandos permitidos, Comandos prohibidos, Cuándo NO usarla, Cuándo usarla, Detente si, Entradas requeridas, Entregables, Evidencia requerida (+8 more)

### Community 192 - "Skill: observability-audit"
Cohesion: 0.12
Nodes (16): Comandos permitidos, Comandos prohibidos, Cuándo NO usarla, Cuándo usarla, Detente si, Entradas requeridas, Entregables, Evidencia requerida (+8 more)

### Community 193 - "Skill: performance-audit"
Cohesion: 0.12
Nodes (16): Comandos permitidos, Comandos prohibidos, Cuándo NO usarla, Cuándo usarla, Detente si, Entradas requeridas, Entregables, Evidencia requerida (+8 more)

### Community 194 - "Skill: production-verification"
Cohesion: 0.12
Nodes (16): Comandos permitidos, Comandos prohibidos, Cuándo NO usarla, Cuándo usarla, Detente si, Entradas requeridas, Entregables, Evidencia requerida (+8 more)

### Community 195 - "Skill: security-audit"
Cohesion: 0.12
Nodes (16): Comandos permitidos, Comandos prohibidos, Cuándo NO usarla, Cuándo usarla, Detente si, Entradas requeridas, Entregables, Evidencia requerida (+8 more)

### Community 196 - "Auditoría de preparación para producción"
Cohesion: 0.13
Nodes (15): 11. Nota sobre correcciones implementadas, 2. Calificación global, 4. Cobertura de requisitos institucionales, 5. Estado actual frente a estado objetivo, 6.1 Arquitectura general, 6.2 Flujo de ingesta objetivo, 6.3 Regla de publicación, 6. Modelo objetivo (+7 more)

### Community 197 - "Revisión por skill"
Cohesion: 0.14
Nodes (13): `backend-hardening` — Cumple con 2 requisitos operativos abiertos, `backend-production` — Cumple, `clean-code-review` — Cumple, Conclusión, Evidencia base (ejecutada en esta sesión, con la nueva configuración ya presente), Hallazgos nuevos de esta revisión (sobre la organización Claude Code), `library-selection` — Cumple, `observability-audit` — Cumple (+5 more)

### Community 198 - "Ciclo de vida de datos, retención y particionado"
Cohesion: 0.14
Nodes (13): 1. Regla rectora, 2. Clasificación de datos, 3. Retención y archivado, 4.1 Cuándo aplicarlo, 4.2 Claves de partición, 4.3 Procedimiento, 4.4 Creación anticipada de particiones, 4. Particionado (+5 more)

### Community 199 - "14. Tercera intervención: verificación en ejecución real"
Cohesion: 0.15
Nodes (13): 14.1 Defectos encontrados al ejecutar la aplicación, 14.2 EDC-018 — Restauración probada (**cerrado**), 14.3 EDC-019 — Estabilidad bajo carga (**parcialmente cerrado**), 14.4 Verificación funcional en vivo, 14.5 Estado de la verificación, 14.6 Cierre del gate de formato (HD-022), 14.7 Verificación final ejecutada, 14.8 Cierre del gate de dependencias (EDC-027) (+5 more)

### Community 200 - "soak-test.mjs"
Cohesion: 0.21
...
Cohesion: 0.18
Nodes (10): 1. Inventario previo, 2. Respaldo, 3.1 Conflicto crítico: prompt de generación vs. sistema real, 3.2 Riesgo de duplicación de reglas, 3.3 Solapamiento entre reglas del prompt y gates ya existentes, 3. Duplicaciones y conflictos detectados, 4. Contenido obsoleto, 5. Elementos que deben conservarse (+2 more)

### Community 203 - "Informe de instalación"
Cohesion: 0.18
Nodes (10): Autenticación pendiente, Cambios de archivos realizados (sin plugins), Ejecutado y verificado en esta sesión, Estado de instalación de plugins, Informe de instalación, Plugins aprobados para instalar (perfil mínimo, sin auth), Plugins condicionales (requieren decisión o auth), Plugins descartados (+2 more)

### Community 204 - "13. Segunda intervención: cierre de lo pendiente"
Cohesion: 0.18
Nodes (11): 13.10 Lo que sigue bloqueando producción, 13.1 Hallazgos cerrados, 13.2 Auditoría transaccional, 13.3 Resiliencia sin introducir cola, 13.4 Deduplicación de noticias sindicadas, 13.5 Aislamiento institucional, 13.6 Defectos que la verificación real reveló, 13.7 Pruebas (+3 more)

### Community 205 - "9. Evidencias técnicas"
Cohesion: 0.20
Nodes (10): 9.1 Build, tipado y lint, 9.2 Pruebas, 9.3 Inventario del código, 9.4 Verificación de gestión de secretos, 9.5 Búsqueda de conceptos del dominio de inteligencia, 9.6 Verificación del bloqueo de seeds mock, 9.7 Verificación del guard de configuración productiva, 9.8 Evidencias no obtenidas y por qué (+2 more)

### Community 206 - "Observatorio Económico Core — Instrucciones del proyecto"
Cohesion: 0.25
Nodes (7): Comandos verificados (`package.json`), Evidencia, Observatorio Económico Core — Instrucciones del proyecto, Precedencia (mayor a menor), Reglas críticas, Reglas modulares y skills, Stack (no cambiar sin ADR)

### Community 207 - "Informe de validación"
Cohesion: 0.25
Nodes (7): 1. Validación de la configuración creada, 2. Validación de que la configuración no rompe el proyecto, 3. Validaciones que NO se pudieron ejecutar (limitaciones), 4. Acciones pendientes (humano), 5. Elementos no verificados, Informe de validación, Instalación de plugins ejecutada (con autorización)

### Community 208 - "ADR-0014: estrategia de reprocesamiento de observaciones en cuarentena"
Cohesion: 0.25
Nodes (7): ADR-0014: estrategia de reprocesamiento de observaciones en cuarentena, Consecuencias, Contexto, Decisión, Opciones, Restricción de seguridad (bloqueante), Validación

### Community 209 - "12. Cambios implementados en esta intervención"
Cohesion: 0.25
Nodes (8): 12.1 Decisión de arquitectura y su justificación, 12.2 Modelo de datos añadido, 12.3 Garantías impuestas en la base de datos, no en el código, 12.4 Política de publicación, 12.5 Controles frente a entrada no confiable, 12.6 Correcciones en el andamiaje del proyecto, 12.7 Lo que sigue pendiente, 12. Cambios implementados en esta intervención

### Community 210 - "ingestion-results.ts"
Cohesion: 0.17
Nodes (20): RFC-822, datesFromArticles(), main(), readFeeds(), readRendered(), SEED, ADR-0019, clean() (+12 more)

### Community 211 - "structure-validator.ts"
Cohesion: 0.18
Nodes (23): backend(), completeRun(), contentExtension(), localDate(), main(), openRun(), persistEvidence(), request() (+15 more)

### Community 212 - "Matriz de selección de plugins de Claude Code"
Cohesion: 0.29
Nodes (6): Advertencia de verificación (obligatoria), Decisiones por plugin, Matriz de selección de plugins de Claude Code, Perfil mínimo recomendado (sin auth, ejecutar primero), Puntos de detención que requieren autorización humana, Regla de scope aplicada

### Community 213 - "Guía de uso de Claude Code en este proyecto"
Cohesion: 0.29
Nodes (6): Comandos del proyecto (yarn), Comandos internos de Claude Code (integrados en este entorno), Guía de uso de Claude Code en este proyecto, Plugins, Reglas activas por ruta, Skills del proyecto (invócalas por nombre)

### Community 214 - "ADR-0013: idempotencia de replay para la submission de agentes"
Cohesion: 0.29
Nodes (6): ADR-0013: idempotencia de replay para la submission de agentes, Consecuencias, Contexto, Decisión, Opciones, Validación

### Community 215 - "Plan de mejora de hardening — Julio 2026"
Cohesion: 0.29
Nodes (6): Baseline verificado (2026-07-21), Estado final de ejecución, Fases de ejecución, Matriz de hallazgos, Plan de mejora de hardening — Julio 2026, Restricciones respetadas

### Community 216 - "1. Resumen ejecutivo"
Cohesion: 0.29
Nodes (7): 1.1 Qué es realmente este repositorio, 1.2 El hallazgo dominante, 1.3 Nivel de preparación, 1.4 Bloqueos de producción, 1.5 Fortalezas (reales y verificadas), 1.6 Recomendación final, 1. Resumen ejecutivo

### Community 217 - "7. Roadmap"
Cohesion: 0.29
Nodes (7): 7.1 Decisión previa (bloquea todo lo demás), 7.2 Correcciones críticas antes de producción, 7.3 Primer mes, 7.4 Corto plazo, 7.5 Mediano plazo, 7.6 Evolución avanzada, 7. Roadmap

### Community 220 - "readSeed"
Cohesion: 0.33
Nodes (5): RFC-9530, assessSourceContentDigest(), SourceContentDigestAssessment, bytes, digest

### Community 221 - "Configuración de Claude Code para este proyecto"
Cohesion: 0.33
Nodes (5): Configuración de Claude Code para este proyecto, Contenido, Cómo se usa, Fuente de verdad, Plugins

### Community 222 - "Inventario de entorno para Claude Code"
Cohesion: 0.33
Nodes (5): Contradicción crítica detectada (Fase 2, regla 8), Datos NO verificables en esta sesión (limitaciones), Gates de calidad ya existentes (18 en `quality:all`), Inventario de entorno para Claude Code, Stack real detectado (evidencia = código, no suposición)

### Community 223 - "Certificación Beta 2.0"
Cohesion: 0.33
Nodes (5): Certificación Beta 2.0, No ejecutables aquí (requieren entorno/psql, no código), Roadmap con ADR (decisión deliberada — no bloquean la beta), Tabla de evidencia por control, Veredicto

### Community 224 - "Registro de prueba de restauración"
Cohesion: 0.33
Nodes (5): Alcance y límites de esta prueba, Conclusión, Garantías tras la restauración, Registro de prueba de restauración, Verificación de integridad

### Community 225 - "Registro de prueba de estabilidad bajo carga"
Cohesion: 0.33
Nodes (5): Conclusión, Lectura, Límites de esta prueba, Registro de prueba de estabilidad bajo carga, Resultado por indicador

### Community 226 - "generate_postman.py"
Cohesion: 0.14
...
Cohesion: 0.08
Nodes (32): DataEntryBatchModel, Column, Table, assertBatchFingerprint(), batchRequestFingerprint(), manualRequestFingerprint(), replayBatchImport(), replayRegistration() (+24 more)
...
Cohesion: 0.31
Nodes (8): dailyPayload(), reconcileArtifact(), reconcileMarketPrices(), reconcileSeries(), MarketPrices, marketPricesSchema, MarketSeries, date

### Community 233 - "10. Decisión final"
Cohesion: 0.50
...
### Community 237 - "disclosure.policy.ts"
Cohesion: 0.27
...
Cohesion: 0.33
Nodes (8): articlePayload(), reconcileIndexArtifact(), reconcilePressArchive(), reconcileYear(), YEARS, ArchivedArticle, PressArchive, pressArchiveSchema
...
### Community 241 - "0017-create-intelligence-audit-schemas.ts"
Cohesion: 0.15
...
### Community 245 - "collect-bcb-quotes.ts"
Cohesion: 0.32
Nodes (7): main(), MONTHS, Quote, SEED, tableDate(), TARGETS, toNumber()

### Community 246 - "0022-add-intelligence-foreign-keys.ts"
Cohesion: 0.14
Nodes (13): Acceso, Consultas de partida, Códigos de indicador, De dónde sale el valor, De dónde sale la historia, Limitaciones, Modelos de lectura para el tablero de indicadores, Promedio diario frente a lectura puntual (+5 more)

### Community 247 - "0023-add-intelligence-indexes.ts"
Cohesion: 0.17
...
### Community 248 - "currencySeedSchema"
Cohesion: 0.19
Nodes (13): downloadEvidenceSource(), assertPublicResolution(), Fetcher, fetchPublicSource(), HostResolver, isPrivateAddress(), readResponseBodyLimited(), SourceFetchResult (+5 more)

### Community 250 - ".importBatch"
Cohesion: 0.43
Nodes (5): ObservationRecordInput, RegisterWithinBatchInput, StructureRepository, Injectable, item()

### Community 251 - "0027-create-intelligence-cluster-tables.ts"
Cohesion: 0.18
Nodes (10): 1. La identidad del editor puede establecerla el dominio descargado, 2. El impacto deja de bloquear una lectura de indicador, 3. Cobertura garantizada frente a cobertura deseable, 4. El dólar paralelo se observa donde se cotiza, 5. El presupuesto de tokens es parte del contrato con el proveedor, ADR-0017: recolección diaria determinista y publicación de lecturas de indicador, Consecuencias, Contexto (+2 more)

### Community 252 - "0028-grant-intelligence-cluster-tables.ts"
Cohesion: 0.20
...
Cohesion: 0.22
Nodes (14): ADR-0006, fastifyTracingInstrumentation(), fastifyTracingPlugin(), UNTRACED_PATHS, createInstrumentations(), redactHttpTarget(), isUntracedTarget(), pathOf() (+6 more)

### Community 265 - "jwks-rsa"
Cohesion: 0.29
Nodes (8): enum, enum, city, department, Cochabamba, La Paz, Santa Cruz, Santa Cruz de la Sierra
...
### Community 268 - "messaging-trace.service.ts"
Cohesion: 0.39
Nodes (6): dailyPayload(), reconcileArtifact(), reconcileBcbQuotes(), BcbQuote, BcbQuotes, bcbQuotesSchema

### Community 269 - "SeriesModel"
Cohesion: 0.22
Nodes (8): 1. El arranque deja la base como la espera el build, 2. La serie histórica se versiona, no se descarga al arrancar, 3. Promedio diario y lectura puntual no se mezclan en silencio, ADR-0018: aprovisionamiento de la base al arrancar y carga histórica versionada, Alternativas descartadas, Contexto, Decisiones, Evidencia

### Community 270 - "HttpExceptionFilter"
Cohesion: 0.60
Nodes (5): fail(), log(), run_pg(), scalar(), migrate_to_new_primary.sh script

### Community 272 - "measure-collection-quality.ts"
Cohesion: 0.43
Nodes (6): filingPayload(), reconcileCompanyFilings(), reconcileFilingArtifact(), CompanyFiling, CompanyFilings, companyFilingsSchema

### Community 274 - "0006-create-quality_lineage-tables.ts"
Cohesion: 0.22
...
### Community 277 - "0011-add-statistical-context-triggers.ts"
Cohesion: 0.50
Nodes (3): ClassificationMappingModel, Column, Table

### Community 279 - "0039-expose-filing-document-text.ts"
Cohesion: 0.73
Nodes (5): build_cases(), ensure_duckdb(), main(), q(), resolve_city_areas()

### Community 280 - "0010-add-domain-integrity-constraints.ts"
Cohesion: 0.50
Nodes (3): FrequencyModel, Column, Table

### Community 282 - "0010-add-domain-integrity-constraints.ts"
Cohesion: 0.40
Nodes (5): quality_grade, enum, A, B, C

### Community 284 - "0017-create-intelligence-audit-schemas.ts"
Cohesion: 0.40
Nodes (3): ObservationModel, Column, Table

### Community 286 - "0029-grant-reader-raw-observation-metrics-columns.ts"
Cohesion: 0.50
Nodes (4): validation_priority, enum, HIGH, NORMAL

### Community 288 - "source-text-decoding.ts"
Cohesion: 0.25
Nodes (11): canonicalSourceUrl(), htmlSourceMetadata, jsonLdValues(), tagAttributes(), byteOrderMark(), declaredCharset(), decodeSourceText(), encodingAliases (+3 more)

### Community 289 - "Plan de corrección de hardening — 30 de julio de 2026"
Cohesion: 0.25
...
### Community 290 - "05 — Coste medido de la instrumentación"
Cohesion: 0.25
...
### Community 291 - "06 — Runbook operativo de trazabilidad"
Cohesion: 0.25
...
### Community 292 - "Verificación de recolección diaria — 2026-08-23"
Cohesion: 0.25
Nodes (7): Confirmación en produccion, Dos defectos que este procedimiento descubrió y que quedaron corregidos, Limitaciones, Procedimiento, Punto de partida, Resultado, Verificación de recolección diaria — 2026-08-23

### Community 293 - "Runbook: backend en Render para el colector de ChatGPT con clave compartida"
Cohesion: 0.25
...
### Community 296 - "evidence-content-type.ts"
Cohesion: 0.52
Nodes (5): assessEvidenceContentType(), effectiveContentType(), EvidenceContentTypeAssessment, normalizedMediaType(), sniffedContentType()

### Community 297 - "6. Diccionario de campos y validaciones exactas"
Cohesion: 0.33
...
### Community 298 - "pdf-text-extractor.mjs"
Cohesion: 0.70
Nodes (4): itemText(), main(), metadataString(), readStandardInput()

### Community 299 - "5. La llamada diaria principal"
Cohesion: 0.50
...
### Community 300 - "8. Plan de cobertura — poblar el máximo de datos económicos"
Cohesion: 0.50
...
### Community 301 - "7. Cómo decide el backend qué se publica — y qué implica para ti"
Cohesion: 0.67
...
### Community 306 - "StatisticalDomainModel"
Cohesion: 0.50
Nodes (3): StatisticalDomainModel, Column, Table

### Community 307 - "0033-choose-official-side-for-gap.ts"
Cohesion: 0.67
Nodes (3): type, confidence, number

### Community 311 - "observation-normalizer.ts"
Cohesion: 0.13
Nodes (6): ADR-0020, ADR-0022, ADR-0025, ADR-0022, ADR-0023, ADR-0025

### Community 312 - "collect-owid-indices.ts"
Cohesion: 0.38
Nodes (6): collectIndex(), IndexPoint, main(), plainValue(), Requested, SEED

### Community 313 - "ADR 0021 — La curva de rendimientos vive fuera de las lecturas medidas"
Cohesion: 0.33
Nodes (5): ADR 0021 — La curva de rendimientos vive fuera de las lecturas medidas, Consecuencias, Contexto, Decisión, El conflicto

### Community 314 - "build_openapi.py"
Cohesion: 0.47
Nodes (3): operation(), ref(), response()

### Community 316 - "validate_contract_routes.py"
Cohesion: 0.80
Nodes (4): controller_routes(), main(), normalize(), openapi_routes()

### Community 326 - "boot-seed.press-coverage.ts"
Cohesion: 0.09
Nodes (38): rawPayloadHash(), ClaimEvidenceModel, Column, Table, FactClaimModel, Column, Table, SourceArtifactModel (+30 more)

### Community 328 - "main.ts"
Cohesion: 0.24
Nodes (10): test, createContractApplication(), createDatabaseDouble(), exportOpenApi(), AppModule, Module, createRequestId(), bootstrap() (+2 more)

### Community 334 - "ADR-0019: cobertura de prensa y listados que exigen renderizado"
Cohesion: 0.18
...
Cohesion: 0.05
Nodes (38): databaseErrorCode(), isRetryableTransactionError(), RETRYABLE_TRANSACTION_CODES, retryDelay(), TransactionRetryOptions, withSerializableRetry(), AgentRunModel, Column (+30 more)
...
### Community 377 - "ADR 0022 — Las lecturas sociales entran como expectativa, nunca como medición"
Cohesion: 0.15
Nodes (12): 1. Se agrega el nivel `SOCIAL`, y su significado es lo contrario de una credencial, 2. Lo que se ingiere es la lectura publicada, no la plataforma, 3. El grado de evidencia viaja con la cifra, 4. El digest identifica el registro, no la publicación, 5. La clasificación se deriva en SQL, como en prensa, ADR 0022 — Las lecturas sociales entran como expectativa, nunca como medición, Alternativas descartadas, Consecuencias (+4 more)

### Community 378 - "ADR 0023 — El comercio se lee por su forma de hacer negocio, no por la plataforma"
Cohesion: 0.15
Nodes (12): 1. `COMMERCE` deja de significar «compras en plataformas» y pasa a significar «formas de comerciar», 2. La forma de hacer negocio se deriva en SQL, desde la etiqueta, 3. La suma de canales se publica con el nombre de lo que es, 4. Los huecos son filas, 5. La distancia contra la serie medida es el indicador, también aquí, ADR 0023 — El comercio se lee por su forma de hacer negocio, no por la plataforma, Alternativas descartadas, Consecuencias (+4 more)

### Community 381 - "ADR 0024 — El panel mundial entra completo, no como lista de lectura"
Cohesion: 0.15
Nodes (12): 1. Entra la colección completa, no una selección, 2. La procedencia es por serie, nunca por corpus, 3. El archivo guarda tripletas, no objetos, 4. El cargador agrupa, y esa es la única diferencia, 5. El panel se lee aparte de las series medidas de Bolivia, ADR 0024 — El panel mundial entra completo, no como lista de lectura, Alternativas descartadas, Consecuencias (+4 more)

### Community 382 - ".transitionIssue"
Cohesion: 0.15
Nodes (12): 1. El asunto se cierra en `COMMERCE`, 2. El nivel `SOCIAL` desaparece del registro de fuentes, 3. La migración avanza; no reescribe, 4. Lo retirado se deja de servir, no se borra, 5. Los nombres de los objetos no cambian, ADR 0025 — El registro lee comercio, no plataformas, Alternativas descartadas, Consecuencias (+4 more)

### Community 387 - "0026-add-observation-and-retry-columns.ts"
Cohesion: 0.26
Nodes (10): collectSeries(), lastCompletedYear(), main(), Observation, plainValue(), SEED, SeriesPoint, Requested (+2 more)

### Community 391 - "collect-comtrade-trade.ts"
Cohesion: 0.31
Nodes (9): aggregateRow(), collectFlow(), fetchYear(), Flow, FLOWS, main(), Row, SEED (+1 more)

### Community 392 - "report-informal-trade.ts"
Cohesion: 0.19
Nodes (14): BatchRow, main(), share(), verdict(), coveragePanel(), CoverageRow, gapPanel(), GapRow (+6 more)

### Community 397 - "refresh-social-snapshot.ts"
Cohesion: 0.21
Nodes (10): main(), main(), Summary, main(), RegisterSummary, ADR-0025, createWriterDatabase(), dialectOptions() (+2 more)

## Knowledge Gaps
- **1724 isolated node(s):** `Incluye`, `Opción 1 — macOS / Ubuntu / Linux`, `Opción 2 — Docker`, `Opción 3 — Manual`, `Windows PowerShell` (+1719 more)
...
- **Why does `sequelize` connect `data-query.controller.ts` to `health.controller.ts`, `ConceptModel`, `quality.controller.ts`, `@fastify/helmet`, `actor.ts`, `observation-registration.service.ts`, `ClassificationVersionModel`, `MethodologyVersionModel`, `verified-source-registry.ts`, `reapply-runtime-grants.ts`, `dependencies`, `batch-idempotency.ts`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `data-query.controller.ts`, `batch-idempotency.ts`, `yaml`, `package.json`, `fastify`, `@fastify/helmet`, `@fastify/rate-limit`, `@fastify/static`, `jwks-rsa`, `@nestjs/core`, `@nestjs/platform-fastify`, `@nestjs/swagger`, `@opentelemetry/instrumentation-nestjs-core`, `@opentelemetry/instrumentation-pg`, `@opentelemetry/instrumentation-pino`, `@opentelemetry/resources`, `@opentelemetry/sdk-node`, `@opentelemetry/sdk-trace-base`, `@opentelemetry/semantic-conventions`, `pino`, `pino-http`, `prom-client`, `rxjs`, `sequelize-typescript`, `zod`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `withSerializableRetry()` connect `verified-source-registry.ts` to `environment.ts`, `HttpExceptionFilter`, `data-query.controller.ts`, `ConceptModel`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **What connects `Incluye`, `Opción 1 — macOS / Ubuntu / Linux`, `Opción 2 — Docker` to the rest of the system?**

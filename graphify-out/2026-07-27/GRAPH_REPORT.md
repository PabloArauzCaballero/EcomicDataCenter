...
5. `IntelligenceWriteRepository` - 29 edges
6. `Lineamientos de programación profesional para código en producción` - 26 edges
7. `sequelize` - 25 edges
8. `GovernanceController` - 24 edges
9. `3. Matriz de hallazgos` - 23 edges
10. `AuditService` - 21 edges
...
Cohesion: 0.18
Nodes (11): geographicUnitSeedSchema, statisticalDomainSeedSchema, code(), date, nullableText(), uuid, artifactSchema, conceptSchema (+3 more)
...
Cohesion: 0.16
Nodes (11): ObservationAttributeValueModel, Column, Table, ObservationMeasureModel, Column, Table, SeriesDimensionValueModel, Column (+3 more)

### Community 3 - "Roles"
Cohesion: 0.15
Nodes (10): ProvenanceController, ApiBearerAuth, ApiOperation, ApiTags, Body, Controller, Post, ProvenanceService (+2 more)
...
Cohesion: 0.15
Nodes (6): DomainCountsRow, DomainMetricsCollector, Injectable, MetricsService, Injectable, Inject

### Community 6 - "quality.controller.ts"
Cohesion: 0.09
Nodes (19): DataIssueModel, Column, Table, QualityController, ApiBearerAuth, ApiOperation, ApiTags, Body (+11 more)
...
Cohesion: 0.05
Nodes (42): dist, jest, node, node_modules, scripts/**/*.ts, src/app.module.ts, src/common/**/*.ts, src/config/**/*.ts (+34 more)
...
Cohesion: 0.20
Nodes (11): attributeValueSchema, decimal, ImportObservationBatchInput, importObservationBatchSchema, isoDate, measureValueSchema, observationRecordSchema, RegisterObservationInput (+3 more)
...
Cohesion: 0.12
Nodes (13): environment, LoggableRequest, LoggableResponse, AuditModule, Global, Module, RequestContextInterceptor, Injectable (+5 more)

### Community 17 - "observation-registration.service.ts"
Cohesion: 0.16
Nodes (13): BatchRegistrationCache, IngestionModule, Module, RegisterWithinBatchInput, RegistrationWithoutBatch, BatchClaimInput, EvaluationResult, nonNegativeConfig (+5 more)

### Community 18 - "mock-seed.metadata.ts"
Cohesion: 0.07
Nodes (35): AttributeDefinitionModel, Column, Table, DataStructureModel, Column, Table, DatasetIndicatorModel, Column (+27 more)

### Community 19 - "DatasetVersionModel"
Cohesion: 0.05
Nodes (50): canonicalHash(), canonicalize(), textHash(), ClaimContent, claimContentHash(), claimSubject, evidenceHash(), isComparableSubject() (+42 more)

### Community 20 - "MethodologyVersionModel"
Cohesion: 0.07
Nodes (23): DatasetModel, Column, Table, MethodologyVersionModel, Column, Table, DatasetService, Inject (+15 more)
...
Cohesion: 0.15
Nodes (16): Path, main(), main(), iter_core_typescript_files(), iter_files(), iter_maintained_code_files(), Yield unique files from explicit roots without traversing quarantined code., Yield TypeScript files that belong to the deployed application graph. (+8 more)

### Community 23 - "observation-write.repository.ts"
Cohesion: 0.50
Nodes (3): DataEntryBatchModel, Column, Table

### Community 24 - "metadata-catalog.service.ts"
Cohesion: 0.33
Nodes (4): StatisticalOperationModel, Column, Table, CreateStatisticalOperationInput
...
Cohesion: 0.09
Nodes (23): ApplicationError, BusinessRuleError, ConflictError, ErrorCode, InfrastructureError, NotFoundError, SafeErrorLog, stringProperty() (+15 more)

### Community 28 - "batch-idempotency.ts"
Cohesion: 0.39
Nodes (7): assertBatchFingerprint(), manualRequestFingerprint(), replayBatchImport(), replayRegistration(), manual(), record(), UUIDS
...
Cohesion: 0.12
Nodes (10): DatabasePoolMetricsCollector, PoolSnapshot, readPool(), Inject, Injectable, DatabaseLifecycle, DatabaseModule, Global (+2 more)

### Community 31 - "batch-import.service.ts"
Cohesion: 0.21
Nodes (9): HttpCode, CurrentActor, Roles(), ApiOperation, Body, Post, Get, Param (+1 more)

### Community 32 - ".registerWithinBatch"
Cohesion: 0.12
Nodes (9): batchRequestFingerprint(), BatchImportService, Inject, Injectable, ObservationRegistrationService, Inject, Injectable, ObservationWriteRepository (+1 more)

### Community 33 - "health.controller.ts"
Cohesion: 0.19
Nodes (13): ProvenanceModule, Module, CreateOrganizationInput, createOrganizationSchema, CreateSourceArtifactInput, createSourceArtifactSchema, CreateSourceInput, createSourceSchema (+5 more)

### Community 34 - "DimensionDefinitionModel"
Cohesion: 0.09
Nodes (32): AuditService, Injectable, Actor, AgentRunModel, Column, Table, AiAgentModel, Column (+24 more)
...
Cohesion: 0.13
Nodes (16): load_fk_targets(), migration_source(), normalized_type(), parse_tables(), Path, split_definitions(), build_entity(), build_tags() (+8 more)

### Community 40 - "MetricsService"
Cohesion: 0.29
Nodes (6): Inject, Environment, DatabaseConnectionFactories, DatabaseConnections, defaultFactories, initializeDatabaseConnections()
...
Cohesion: 0.18
Nodes (8): LineageRelationModel, Column, Table, ObservationRevisionModel, Column, Table, RevisionWriteRepository, Injectable
...
Cohesion: 0.17
Nodes (11): description, engines, node, license, name, packageManager, private, resolutions (+3 more)
...
Cohesion: 0.07
Nodes (18): ClassificationMappingModel, Column, Table, FrequencyModel, Column, Table, GeographicUnitModel, Column (+10 more)
...
Cohesion: 0.19
Nodes (15): reconcileCountries(), reconcileCurrencies(), reconcileEconomicActivities(), reconcileFrequencies(), reconcileGeographicUnits(), reconcileQualityDimensions(), reconcileStatisticalDomains(), reconcileUnits() (+7 more)
...
Cohesion: 0.05
Nodes (34): createReaderDatabase(), dialectOptions(), PostgresDialectOptions, AuditLogModel, Column, Table, ClaimClusterMemberModel, Column (+26 more)

### Community 138 - "@fastify/helmet"
Cohesion: 0.21
Nodes (11): createWriterDatabase(), CodeItemModel, Column, Table, CodeListModel, Column, Table, reconcileMockSemantics() (+3 more)
...
Cohesion: 0.12
Nodes (16): ADR-0003, RawObservationModel, Column, Table, DailyAnalysisResult, DeadLetterItem, ReprocessResult, SubmissionOutcome (+8 more)

### Community 168 - "data-query.controller.ts"
Cohesion: 0.07
Nodes (36): DataQueryController, ApiBearerAuth, ApiOperation, ApiTags, Body, Controller, CurrentActor, Get (+28 more)
...
Cohesion: 0.16
Nodes (11): OrganizationModel, Column, Table, SourceArtifactModel, Column, Table, SourceModel, Column (+3 more)

### Community 171 - "read-query.executor.ts"
Cohesion: 0.12
Nodes (25): AGENT_TYPES, CLAIM_TYPES, claimQuerySchema, claimSchema, code, CompleteAgentRunInput, completeAgentRunSchema, CONFIDENCE_LEVELS (+17 more)

### Community 172 - "DataQueryController"
Cohesion: 0.10
Nodes (18): sequelize, ensureGroupRole(), ensureLoginRole(), GROUP_ROLES, LoginRole, main(), requireEnv(), sequelize (+10 more)

### Community 173 - "export-openapi.ts"
Cohesion: 0.26
Nodes (10): test, createContractApplication(), createDatabaseDouble(), exportOpenApi(), AppModule, Module, DATABASE_CONNECTIONS, bootstrap() (+2 more)
...
Cohesion: 0.29
Nodes (10): canonicalize(), captureBootSeedHash(), captureMockSeedHash(), hashSnapshot(), querySnapshot(), SnapshotRow, BOOT_FREQUENCY_IDS, BOOT_QUALITY_DIMENSION_IDS (+2 more)

### Community 176 - "JwtAuthGuard"
Cohesion: 0.19
Nodes (7): JwtAuthGuard, TokenClaims, Injectable, ConfigurationModule, ENVIRONMENT, Global, Module

### Community 177 - "Public"
Cohesion: 0.15
Nodes (10): Headers, Public, Res, HealthController, matchesBearerToken(), Controller, Get, Inject (+2 more)
...
Cohesion: 0.25
Nodes (15): Query, Req, IntelligenceController, ApiBearerAuth, ApiOperation, ApiTags, Body, Controller (+7 more)
...
Cohesion: 0.17
Nodes (13): ClaimReviewController, ApiBearerAuth, ApiOperation, ApiTags, Body, Controller, CurrentActor, HttpCode (+5 more)

### Community 187 - "quality.controller.ts"
Cohesion: 0.16
Nodes (14): Injectable, ZodValidationPipe, createIndicatorRelationSchema, createLineageRelationSchema, createQualityDimensionSchema, createQualityRuleSchema, createSeriesBreakSchema, date (+6 more)
...
Cohesion: 0.25
Nodes (7): BatchImportResult, batchImportResultSchema, BatchRecordResult, batchRecordResultSchema, identifier, RegistrationResult, registrationResultSchema

### Community 211 - "structure-validator.ts"
Cohesion: 0.39
Nodes (7): AttributeValueInput, MeasureValueInput, assertExactDefinitions(), attributeValueKind(), dimensionValueKind(), measureValueKind(), validateRecordAgainstStructure()
...
### Community 218 - ".createIndicatorRelation"
Cohesion: 0.33
Nodes (4): IndicatorRelationModel, Column, Table, CreateIndicatorRelationInput

### Community 219 - ".createSeriesBreak"
Cohesion: 0.33
Nodes (4): SeriesBreakModel, Column, Table, CreateSeriesBreakInput

### Community 220 - "readSeed"
Cohesion: 0.38
Nodes (3): readSeed(), validateSeedFiles(), mockSeedSchema
...
Cohesion: 0.60
Nodes (3): ObservationRecordInput, StructureRepository, Injectable

### Community 228 - "Trazabilidad de skills y reglas"
Cohesion: 0.40
Nodes (4): Nota de atribución, Reglas, Skills, Trazabilidad de skills y reglas

### Community 229 - "dimension-value.schema.ts"
Cohesion: 0.40
Nodes (4): decimal, dimensionValueSchema, isoDate, uuid

### Community 230 - "ConceptModel"
Cohesion: 0.40
Nodes (3): ConceptModel, Column, Table

### Community 231 - "IngestionController"
Cohesion: 0.40
Nodes (4): IngestionController, ApiBearerAuth, ApiTags, Controller

### Community 232 - ".listIssues"
Cohesion: 0.50
Nodes (3): Get, Query, IssueListInput
...
### Community 234 - "ObservationModel"
Cohesion: 0.50
Nodes (3): ObservationModel, Column, Table

### Community 235 - "QualityAssessmentModel"
Cohesion: 0.50
Nodes (3): QualityAssessmentModel, Column, Table

### Community 236 - "QualityDimensionModel"
Cohesion: 0.50
Nodes (3): QualityDimensionModel, Column, Table

### Community 237 - "QualityRuleModel"
Cohesion: 0.50
Nodes (3): QualityRuleModel, Column, Table

### Community 238 - "SeriesModel"
Cohesion: 0.50
Nodes (3): SeriesModel, Column, Table

## Knowledge Gaps
- **1156 isolated node(s):** `Contenido`, `Cómo se usa`, `Plugins`, `Fuente de verdad`, `Gobernanza y precisión` (+1151 more)
...
- **Why does `sequelize` connect `DataQueryController` to `.registerWithinBatch`, `quality.controller.ts`, `environment.ts`, `database-guarantees.integration-spec.ts`, `Public`, `mock-seed.metadata.ts`, `DatasetVersionModel`, `MethodologyVersionModel`, `withSerializableRetry`, `dependencies`, `application.error.ts`?**
...
- **Why does `Actor` connect `DimensionDefinitionModel` to `.registerWithinBatch`, `data-query.controller.ts`, `actor.ts`, `read-query.executor.ts`, `observation-input.schemas.ts`, `JwtAuthGuard`, `@nestjs/core`, `observation-registration.service.ts`, `UnitMeasureModel`, `Injectable`, `.decide`, `batch-import.service.ts`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **What connects `Contenido`, `Cómo se usa`, `Plugins` to the rest of the system?**
